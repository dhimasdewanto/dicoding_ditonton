...
// in dicoding_ditonton/test/presentation/pages/tv_detail_page_test.dart.
...
import 'package:dicoding_ditonton/domain/usecases/tv/get_tv_detail.dart' as _i2;
...
class MockTvDetailNotifier extends _i1.Mock implements _i8.TvDetailNotifier {
  ...
  @override
  _i12.Future<void> addWatchlist(_i10.Movie? movie) => (super.noSuchMethod(
        Invocation.method(
          #addWatchlist,
          [movie],
        ),
  ...
  @override
  _i12.Future<void> removeFromWatchlist(_i10.Movie? movie) =>
      (super.noSuchMethod(
        Invocation.method(
          #removeFromWatchlist,
          [movie],
