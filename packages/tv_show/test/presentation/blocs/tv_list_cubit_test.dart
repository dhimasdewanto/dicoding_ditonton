...
import 'package:tv_show/presentation/blocs/tv_list_cubit.dart';
...
void main() {
  ...
  group('On The Air TV Shows', () {
    ...
    test('Should change when data is gotten successfully', () async {
      ...
      expect(bloc.state.showsOnTheAir, tDummyList);
  ...
  group('Popular TV Shows', () {
    ...
    test('Should change data when data is gotten successfully',
      ...
      expect(bloc.state.showsPopular, tDummyList);
      expect(listenerCallCount, 1);
    });
  ...
  group('Top Rated TV Shows', () {
    ...
    test('Should change data when data is gotten successfully',
      ...
      expect(bloc.state.showsTopRated, tDummyList);
      expect(listenerCallCount, 1);
    });
